import sys
from antlr4 import *
from sources.MyGrammerLexer import MyGrammerLexer
from sources.MyGrammerParser import MyGrammerParser
from sources.MyGrammerVisitor import MyGrammerVisitor
